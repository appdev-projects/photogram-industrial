...
Rails.application.configure do
  ...
  # Set localhost to be used by links generated in mailer templates. (Also the line needed to be changed when deploying the application. In production host should be set to the host server of app and not personal computer)
