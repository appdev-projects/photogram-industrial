...
class User < ApplicationRecord
  ...
  has_many :accepted_received_follow_requests, -> {accepted}, foreign_key: :sender_id, class_name: "FollowRequest", dependent: :destroy
  ...
  has_many :leaders, through: :sent_follow_requests, source: :recipient,  dependent: :destroy
